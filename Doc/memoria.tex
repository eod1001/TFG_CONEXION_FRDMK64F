...
\newcommand{\nombre}{Enrique del Olmo Dominguez} %%% cambio de comando

% Datos de portada
\title{Comunicacion con Sistemas Embebidos}
\author{\nombre}
\tutor{Alejandro Merino Gomez y Daniel Sarabia Ortiz}
\date{\today}
...
\noindent D. Alejandro Merino Gomez y D. Daniel Sarabia Ortiz, profesores del departamento de Ingeniería Electromecánica y área de Ingeniería de Sistemas y Automática.
...
\begin{abstract}
Los sistemas embebidos (SE) son pequeños controladores capaces de realizar unas tareas determinadas programadas con anterioridad. Este tipo de sistemas son muy utilizados en la actualidad ya que, su hardware, bajo consumo, facilidad de uso y su escalabilidad los hacen propicios para solucionar un montón de tareas. Estas tareas pueden ser desde la inclinación de una cama de hospital a la gestión de de unas cintas transportadoras de elementos en una industria.
...
\begin{abstract}
Sistemas embebidos, Sistemas empotrados, conexion wifi, conexion ethernet, comunicacion entre sistemas, Internet de las cosas (IoT), NXP, uart, I2C, ADC, FRDM K64F. \ldots
\end{abstract}
